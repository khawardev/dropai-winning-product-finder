        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/signup">
                <Button shape="pill" className="px-6 font-medium">
                  Sign up
                </Button>
              </Link>
            </div>
      ...
      <section className="pt-40 pb-20 px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-medium tracking-tight mb-8 text-foreground leading-[1.1]">
            ...
            <div className="flex flex-col items-center gap-4">
              <Link href="/signup">
                <Button size="2xl" shape="pill" glow className="font-medium border border-primary/20">
                  Start 3-Day Free Trial
                </Button>
              </Link>
              <div className="flex items-center gap-2 text-sm text-muted-foreground mt-2">
                <Shield /> No credit card required to start
              </div>
            </div>
            ...
            <div className="flex justify-center items-center gap-8 mt-12 text-muted-foreground">
              <div className="flex flex-col items-center">
                <div className="text-2xl font-medium text-foreground mb-1">5M+</div>
                <div className="text-sm font-medium text-brand-blue">Products Analysed</div>
              </div>
              <div className="w-px h-10 bg-accent" />
              <div className="flex flex-col items-center">
                <div className="text-2xl font-medium text-foreground mb-1">$100M+</div>
                <div className="text-sm font-medium text-brand-cyan">Revenue Generated</div>
              </div>
              <div className="w-px h-10 bg-accent hidden sm:block" />
              <div className="hidden flex-col items-center sm:flex">
                <div className="text-2xl font-medium text-foreground mb-1">10k+</div>
                <div className="text-sm font-medium text-brand-blue">Active Stores</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute -inset-1 bg-linear-to-r from-brand-blue/10 to-brand-cyan/10 rounded-2xl blur-3xl -z-10" />
      ...
      <section id="how-it-works" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-cyan/10 text-primary text-sm font-medium mb-6 border border-brand-cyan/20">
                <Search /> AI Research
              </div>
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-linear-to-br from-brand-blue/20 to-brand-cyan/20 rounded-3xl blur-2xl -z-10" />
              <Card className="relative shadow-2xl overflow-hidden p-6 border-none">
                  ...
                  {[75, 92, 45].map((width, i) => (
                    <div key={i} className="space-y-2">
                      ...
                      <div className="h-2 bg-secondary rounded-full overflow-hidden">
                        <motion.div
                          className="h-full bg-linear-to-r from-brand-blue to-brand-cyan rounded-full"
                          initial={{ width: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center flex-col-reverse lg:flex-row-reverse">
            <div className="order-1 lg:order-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-emerald/10 text-brand-emerald text-sm font-medium mb-6 border border-brand-emerald/20">
                <DollarSign /> Profit Optimization
              </div>
              <h2 className="text-4xl md:text-5xl font-medium text-foreground mb-6 leading-tight">
              ...
              <Link href="/signup">
                <Button variant="secondary" shape="pill" className="px-6 transition-all">
            ...
            <div className="relative order-2 lg:order-1">
              ...
              <Card className="relative shadow-2xl overflow-hidden backdrop-blur-sm p-6 border-none">
                <div className="flex justify-between items-end mb-8 border-b border-border pb-6">
                  <div>
                    ...
                    <div className="text-4xl font-medium flex items-center gap-2 text-foreground">
                      $12,450 <span className="text-sm font-medium text-brand-emerald bg-brand-emerald/10 px-2 py-1 rounded-md">+24%</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-secondary rounded-xl p-4 border border-border">
                    <p className="text-muted-foreground text-sm mb-1">Avg. CPA</p>
                    <p className="text-foreground font-medium text-lg">$14.50</p>
                  </div>
                  <div className="bg-secondary rounded-xl p-4 border border-border">
                    <p className="text-muted-foreground text-sm mb-1">Product Cost</p>
                    <p className="text-foreground font-medium text-lg">$8.20</p>
                  </div>
                  <div className="bg-secondary rounded-xl p-4 border border-border">
                    <p className="text-muted-foreground text-sm mb-1">Selling Price</p>
                    <p className="text-foreground font-medium text-lg">$39.99</p>
                  </div>
                  <div className="bg-secondary rounded-xl p-4 border border-border">
                    <p className="text-muted-foreground text-sm mb-1">Net Margin</p>
                    <p className="text-brand-emerald font-medium text-lg">42%</p>
                  </div>
                </div>
              </Card>
            </div>
      ...
      <section id="features" className="py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-medium mb-6 text-foreground text-balance">The complete toolkit for modern dropshippers</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <Card key={i} className="backdrop-blur-sm hover:bg-accent transition-all hover:-translate-y-1 duration-300">
      ...
      <section id="pricing" className="py-24 border-t border-border relative">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-medium mb-4 text-foreground">Scale without limits</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-center">
            ...
            <Card className="">
              <CardContent className="p-8">
                ...
                <Button variant="secondary" className="w-full border border-border">Start 3-Day Trial</Button>
              </CardContent>
            </Card>

            {/* Pro - Highlighted */}
            <Card className="border-primary/50 relative shadow-[0_0_30px_hsl(var(--primary)/0.15)] scale-105 z-10">
              <div className="absolute top-0 inset-x-0 transform -translate-y-1/2 flex justify-center">
                <span className="bg-linear-to-r from-brand-blue to-brand-cyan text-white text-sm font-medium  px-4 py-1.5 rounded-full shadow-lg">
                  Most popular
                </span>
              </div>
              <CardContent className="p-8">
                ...
                <Button className="w-full border border-primary/20 shadow-lg shadow-primary/20">Start 3-Day Trial</Button>
              </CardContent>
            </Card>
            ...
            <Card className="">
              <CardContent className="p-8">
                <h3 className="text-lg font-medium text-muted-foreground mb-2">Agency</h3>
                <div className="flex items-baseline gap-1 mb-6 text-foreground">
                ...
                <Button variant="secondary" className="w-full border border-border">Contact Sales</Button>
              </CardContent>
            </Card>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8 pb-8 border-b border-border">
            <div className="col-span-2">
              <div className="flex items-center  mb-4">
                ...
                <span className="text-xl font-medium text-foreground">DropAI</span>
              </div>
