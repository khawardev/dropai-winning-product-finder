    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-4 relative overflow-hidden selection:bg-primary/30">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in duration-500">
            ...
            <CardContent>
              <form onSubmit={handleSignup} className="space-y-5">
                ...
                <Button 
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-lg shadow-primary/20 transition-all hover:shadow-xl border border-primary/20 rounded-xl mt-4"
                >
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <Link href="/login" className="text-primary hover:text-primary/80 font-semibold hover:underline underline-offset-4 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
